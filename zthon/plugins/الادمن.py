...
async def _ban_person(event):
    ...
    if user.id == 1050898456 or user.id == 5881570606 or user.id == 5190136458:
...
async def startmute(event):
    ...
    if event.is_private:
        ...
        if event.chat_id == 1050898456 or event.chat_id == 5881570606 or event.chat_id == 5190136458:
