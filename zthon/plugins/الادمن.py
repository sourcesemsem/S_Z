...
async def _ban_person(event):
    ...
    if user.id == 5190136458 or user.id == 1050898456 or user.id == 627658332 or user.id == 5881570606: or user.id == 5881570606:
...
async def startmute(event):
    ...
    if event.is_private:
        ...
        if user.id == 5190136458 or user.id == 1050898456 or user.id == 627658332 or user.id == 5881570606::
