...
ZelzalChecler_cmd = (
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝗰𝗿𝗶𝘀𝘁𝗲𝗻 - اوامـر الصيـد والتشيكـر](t.me/pp_g3) 𓆪\n\n"
        ...
        if isav == True:
            try:
                ...
                await event.client.send_file(
                    event.chat_id,
                    "https://t.me/CU_VC/7000",
                    caption="ᯓ 𓏺𝖲َِ𝘰َِ𝘶َِ𝘳َِ𝘤َِ𝘦 َِ𝘤َِ𝘳َِ𝘪َِ𝘴َِ𝘵َِ𝘦َِ𝘯 - صيـد ڪࢪستيڼ 💡\n**•────────────────────•**\n- UserName: ❲ @{} ❳\n- ClickS: ❲ {} ❳\n- Type: {}\n- Save: ❲ Chaneel ❳\n**•────────────────────•**\n- By ❲ @pp_g3 ❳ ".format(
