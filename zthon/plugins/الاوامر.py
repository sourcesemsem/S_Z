...
async def zed_handler(event):
    ...
    if query.startswith("كرستين") and event.query.user_id == zedub.uid:
        ...
        buttons = [[Button.url("قنـاة السـورس", "https://t.me/pp_g3"),],[Button.url("جروب الرغي", "https://t.me/D_FBJ"), Button.url("الفـارات", "https://t.me/VAR_TEL3"),],[Button.url("الشـروحـات¹", "https://t.me/HELP_TEL3"),],[Button.url("الكلايش", "https://t.me/W_l_N"),],[Button.url("مطـور السـورس", "https://t.me/devpokemon"),]]
...
async def zed_handler(event):
    ...
    if query.startswith("اليدوي") and event.query.user_id == zedub.uid:
        ...
        buttons = [[Button.url("اضغــط هنــا", "https://t.me/HELP_TEL3")]]
...
async def zed_handler(event):
    ...
    if query.startswith("الفيزا") and event.query.user_id == zedub.uid:
        ...
        buttons = [[Button.url("اضغــط هنــا", "https://t.me/PP_G3/663")]]
        result = builder.article(title="zedub",text=zelzal,buttons=buttons,link_preview=False)
        await event.answer([result] if result else None)
...
async def zed_handler(event):
    ...
    if query.startswith("الهيروكو") and event.query.user_id == zedub.uid:
        ...
        buttons = [[Button.url("اضغــط هنــا", "https://youtu.be/_YQAlEIDSno")]]
        result = builder.article(title="zedub",text=zelzal,buttons=buttons,link_preview=False)
        await event.answer([result] if result else None)
...
async def zed_handler(event):
    ...
    if query.startswith("التنصيب") and event.query.user_id == zedub.uid:
        ...
        buttons = [[Button.url("اضغــط هنــا", "https://t.me/PP_G3/662)]]
        result = builder.article(title="zedub",text=zelzal,buttons=buttons,link_preview=False)
        await event.answer([result] if result else None)
